  ...
  const artifact = {
    _meta: buildNflMeta({
      ...
      notes: [
        ...
        "fantasyPointsPpr (passing/QB game rows only) is nflverse stats_player_week's own fantasy_points_ppr column carried verbatim -- Full PPR, never recomputed here. Absent on rushing/receiving rows and on pre-existing older artifacts; consumers treat undefined as 'no value'. Powers the shared Player/Opponent Last-10 'Fantasy PPR Points' column on both the Yardage Props Review and the Fantasy weekly QB detail.",
