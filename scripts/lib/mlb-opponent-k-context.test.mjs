...
describe("mlb opponent K context", () => {
  ...
  it("derives Savant xBA home/away and recent samples and uses the official team filter", async () => {
    const csv = [
      "game_date,events,home_team,away_team,estimated_ba_using_speedangle",
      "2026-07-12,single,ATL,NYM,0.800",
      "2026-07-12,field_out,ATL,NYM,0.200",
      "2026-07-11,strikeout,PHI,ATL,",
      "2026-07-11,double,PHI,ATL,0.600",
      "2026-07-10,field_out,ATL,MIA,0.100",
    ].join("\n");
