...
export const NFL_BETTING_GUIDE_PARTS: GuidePart[] = [
  ...
  },
  {
    ...
    chapters: [
      {
        number: "25–32",
        title: "AFC Team Chapters",
        summary: "Individual pages for all 16 AFC teams using the approved team-page template.",
        status: "planned",
        items: ["AFC East teams", "AFC North teams", "AFC South teams", "AFC West teams"],
      },
      {
        number: "33–40",
        title: "NFC Team Chapters",
        summary: "Individual pages for all 16 NFC teams using the approved team-page template.",
        status: "planned",
        items: ["NFC East teams", "NFC North teams", "NFC South teams", "NFC West teams"],
      },
    ],
  },
  {
