...
import { usOpen2026PicksOverride } from "@/data/pga/overrides/us-open-2026-picks";

const baseUsOpen2026PicksTournament = {
  "id": "us-open-2026",
  "slug": "us-open-2026-picks",
  "season": 2026,
  "name": "U.S. Open",
  "shortName": "U.S. Open",
  ...
  "schedule": {
    "weekLabel": "June 18, 2026 - 21",
    "startDate": "2026-06-18",
    "endDate": "2026-06-21"
  },
  "summary": {
    "blurb": "Shinnecock Hills is the anchor for this week's model build — a precision, approach-first U.S. Open test.",
    "bullets": [
      "Approach play is the #1 separator at Shinnecock (GIR ~53% vs 66% tour avg).",
      "Fairways are catchable but 5-inch fescue severely punishes misses — accuracy over distance.",
      "Firm, crowned greens reward elite around-green and putting under pressure."
    ],
  ...
  "tournamentInfo": {
    "previousWinner": "Bryson DeChambeau (2024) / Brooks Koepka (2018 at Shinnecock)",
    "purse": "$21,500,000",
  ...
  "hero": {
    ...
    "title": "U.S. Open 2026 Picks & Best Bets",
  ...
  "seo": {
    "title": "U.S. Open 2026 Picks, Best Bets & Course-Fit Model",
    "description": "U.S. Open 2026 picks and course-fit model rankings for Shinnecock Hills Golf Club.",
    "faqs": [
      {
        "question": "What matters most for the 2026 U.S. Open at Shinnecock?",
        "answer": "Shinnecock Hills is the anchor for this week's model build — a precision, approach-first U.S. Open test."
      },
      {
  ...
  "model": {
    "dataPath": "/data/pga/us-open-2026.json",
    "eventType": "Major Championship",
    "fieldAverage": "TBD",
    "cutLine": "TBD",
    "noCutLabel": "Standard cut",
    "courseHistoryDisplay": "Shinnecock / U.S. Open",
...
export const usOpen2026PicksTournament = definePgaTournamentConfig(
  applyPgaTournamentOverride(baseUsOpen2026PicksTournament, usOpen2026PicksOverride),
);
