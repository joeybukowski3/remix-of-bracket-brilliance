// CFB Model V2 — dense linear solver (Phase 10 §11, WU2).
//
// A literal, faithful port of src/lib/cfb/research/phase2/linearSolver.ts
// (Gaussian elimination with partial pivoting). This is generic numerical
// linear algebra with zero research-specific logic, so it is duplicated
// here rather than imported at runtime — see architectureGuard.test.ts and
// linearSolver.test.ts (parity against the research original, test-only import).
