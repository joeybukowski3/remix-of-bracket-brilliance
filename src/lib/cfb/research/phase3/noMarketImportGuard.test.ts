...
/**
 * Section 20 leakage/architecture test: Phase 3 must have zero dependency
 * on market-line modules, marketAnchor, MIC, AP poll, or production
 * config. Mirrors phase2/noMarketImportGuard.test.ts's static-import scan.
 */
...
describe("Phase 3 modules have zero market-line / marketAnchor / MIC / production-config dependency", () => {
