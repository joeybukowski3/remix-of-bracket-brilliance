...
/**
 * Section 18 leakage/architecture test: Phase 5 must have zero dependency
 * on market-line modules, marketAnchor, MIC, or production config. Mirrors
 * phase2-4's static-import scan.
 */
...
describe("Phase 5 modules have zero market-line / marketAnchor / MIC / production-config dependency", () => {
