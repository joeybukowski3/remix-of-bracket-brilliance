 ...
 *
 * This is a *separate* domain from WU1-7 betting splits ({@link
 * ../bettingSplitsTypes}). A betting split describes public bet/handle
 * percentages; a betting line describes the raw price a single sportsbook is
 * offering. The two models never merge: this file must not import the splits
 * schema and the splits schema must not import this one.
 *
...
export type BettingLineLeague = "nfl" | "cfb";
