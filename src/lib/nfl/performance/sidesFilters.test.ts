...
function row(overrides: Partial<SidesPerformanceRow> = {}): SidesPerformanceRow {
  return {
    ...
    context: {
      ...
      coaching: { home_coaching_rating: null, away_coaching_rating: null, coaching_advantage_team: null, coaching_differential: null, coaching_context_status: "NOT_IMPLEMENTED" },
    },
