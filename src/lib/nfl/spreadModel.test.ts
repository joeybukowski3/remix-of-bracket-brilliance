...
describe("market independence", () => {
  ...
  // This model's own generator is retired from production (2026-08-19) — it
  // now lives under scripts/analysis/nfl-spread-v0.1.0-legacy/ for
  // historical/model comparison only. public/data/nfl/matchup-projections.json
  // is generated by scripts/generate-nfl-matchup-projections.mts instead,
  // driven by the canonical Current OVR board; that generator's own market
  // independence is covered by src/lib/nfl/jkbPowerNumber2026.test.ts.
  const generatorSource = readFileSync(
    resolve(process.cwd(), "scripts/analysis/nfl-spread-v0.1.0-legacy/generate-legacy-projections.mjs"),
    "utf-8"
  );
  ...
  it("keeps the (retired) generator from importing the market artifact or module", () => {
...
// The "published artifact" suite that used to live here tested
// public/data/nfl/matchup-projections.json against this model's own schema
// (weights, priorK, favoriteTeam/lastSampleGameId, ...). That artifact is
// now generated by scripts/generate-nfl-matchup-projections.mts from the
// canonical Current OVR board instead (2026-08-19) — see
// src/lib/nfl/jkbPowerSpreadArtifact.test.ts for its own invariants.
