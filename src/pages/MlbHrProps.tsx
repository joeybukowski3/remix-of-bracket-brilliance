...
import {
  buildPitcherStrikeoutMatchupRows as sharedBuildPitcherStrikeoutMatchupRows,
 ...
 * in src/lib/mlb/mlbSocialSelection.ts, a dependency-free module also
 * consumed directly by scripts/generate-social-card-live.ts (a plain
 * Node/tsx script that cannot import this file, since it pulls in React
 * component imports at module scope). Do not reimplement selection logic
 * here; edit the shared module instead.
 */
export const buildPitcherStrikeoutRows = sharedBuildPitcherStrikeoutRows;
export const buildPitcherStrikeoutMatchupRows = sharedBuildPitcherStrikeoutMatchupRows;
export const buildTbdGameKeySet = sharedBuildTbdGameKeySet;
