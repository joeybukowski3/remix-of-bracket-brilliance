...
const STYLES = `
  ...
  .nfl-pr-group{border-top:1px solid #e2e8f0}.nfl-pr-group:first-of-type{border-top:none}
  .nfl-pr-grouplabel{display:flex;align-items:baseline;gap:8px;padding:12px 14px 6px}
  .nfl-pr-grouplabel-eyebrow{font-size:10px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;color:#64748b}
  .nfl-pr-grouplabel-name{font-size:14px;font-weight:800;color:#0f172a;letter-spacing:-.01em}
  .nfl-pr-grouplabel-count{font-size:11px;color:#94a3b8;margin-left:auto}
  ...
  .nfl-pr-stickyclone{position:fixed;top:73px;z-index:20;display:flex;background:#0f172a;color:#f8fafc;font-size:10px;font-weight:700;letter-spacing:.07em;text-transform:uppercase;border-bottom:2px solid #1e293b;pointer-events:none}
  .nfl-pr-stickyclone-team{flex:0 0 200px;width:200px;display:flex;align-items:center;padding:9px 6px;text-align:left;z-index:1;background:#0f172a;border-right:2px solid #1e293b;box-sizing:border-box}
  .nfl-pr-stickyclone-clip{flex:1 1 auto;min-width:0;overflow:hidden}
  .nfl-pr-stickyclone-row{display:flex;width:max-content}
  .nfl-pr-stickyclone-cell{flex:0 0 74px;width:74px;padding:9px 6px;text-align:center;box-sizing:border-box}
  .nfl-pr-stickyclone-cell--record{flex-basis:64px;width:64px}
