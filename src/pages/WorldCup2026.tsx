...
const DISPLAY_GROUPS: { label: string; teams: Team[] }[] = [
  ...
  },
  {
    ...
    teams: [
      { name: "Norway",      code: "no", group: "B", powerScore: 70, attack: 74, defense: 67, form: 72, fifaRank: 12, advancedToKO: true },
      { name: "S. Korea",    code: "kr", group: "B", powerScore: 60, attack: 62, defense: 59, form: 61, fifaRank: 22, advancedToKO: true },
      { name: "Tunisia",     code: "tn", group: "B", powerScore: 55, attack: 54, defense: 57, form: 53, fifaRank: 26, advancedToKO: false },
      { name: "Bolivia",     code: "bo", group: "B", powerScore: 46, attack: 44, defense: 48, form: 45, fifaRank: 73, advancedToKO: false },
    ],
  },
  {
  ...
  },
  {
    ...
    teams: [
      { name: "England",     code: "gb-eng", group: "D", powerScore: 80, attack: 81, defense: 78, form: 81, fifaRank: 4,  advancedToKO: true },
      { name: "Switzerland", code: "ch",      group: "D", powerScore: 67, attack: 64, defense: 71, form: 65, fifaRank: 13, advancedToKO: true },
      { name: "Uzbekistan",  code: "uz",      group: "D", powerScore: 52, attack: 51, defense: 53, form: 50, fifaRank: 68, advancedToKO: false },
      { name: "Chile",       code: "cl",      group: "D", powerScore: 62, attack: 64, defense: 60, form: 61, fifaRank: 24, advancedToKO: false },
    ],
  },
  {
    ...
    teams: [
      { name: "Argentina",   code: "ar", group: "E", powerScore: 90, attack: 92, defense: 84, form: 88, fifaRank: 2,  advancedToKO: true },
      { name: "Portugal",    code: "pt", group: "E", powerScore: 83, attack: 86, defense: 77, form: 82, fifaRank: 7,  advancedToKO: true },
      { name: "Uruguay",     code: "uy", group: "E", powerScore: 65, attack: 67, defense: 64, form: 63, fifaRank: 18, advancedToKO: false },
      { name: "Ghana",       code: "gh", group: "E", powerScore: 57, attack: 56, defense: 58, form: 55, fifaRank: 51, advancedToKO: false },
    ],
  },
  {
    ...
    teams: [
      { name: "USA",         code: "us", group: "F", powerScore: 73, attack: 70, defense: 72, form: 74, fifaRank: 11, advancedToKO: true },
      { name: "Canada",      code: "ca", group: "F", powerScore: 71, attack: 70, defense: 70, form: 72, fifaRank: 13, advancedToKO: true },
      { name: "Iran",        code: "ir", group: "F", powerScore: 60, attack: 58, defense: 62, form: 59, fifaRank: 25, advancedToKO: false },
      { name: "Panama",      code: "pa", group: "F", powerScore: 51, attack: 49, defense: 53, form: 50, fifaRank: 43, advancedToKO: false },
    ],
  },
  {
    label: "Group G",
    teams: [
      { name: "Spain",       code: "es", group: "G", powerScore: 91, attack: 89, defense: 86, form: 92, fifaRank: 8,  advancedToKO: true },
      { name: "Colombia",    code: "co", group: "G", powerScore: 72, attack: 73, defense: 68, form: 70, fifaRank: 10, advancedToKO: true },
      { name: "Austria",     code: "at", group: "G", powerScore: 59, attack: 60, defense: 57, form: 58, fifaRank: 26, advancedToKO: false },
      { name: "Morocco",     code: "ma", group: "G", powerScore: 63, attack: 60, defense: 67, form: 64, fifaRank: 15, advancedToKO: false },
    ],
  },
  {
    label: "Group H",
    teams: [
      { name: "France",      code: "fr", group: "H", powerScore: 89, attack: 88, defense: 87, form: 87, fifaRank: 3,  advancedToKO: true },
      { name: "Germany",     code: "de", group: "H", powerScore: 82, attack: 83, defense: 80, form: 79, fifaRank: 5,  advancedToKO: true },
      { name: "Belgium",     code: "be", group: "H", powerScore: 76, attack: 77, defense: 73, form: 74, fifaRank: 9,  advancedToKO: false },
      { name: "Sweden",      code: "se", group: "H", powerScore: 61, attack: 62, defense: 63, form: 59, fifaRank: 21, advancedToKO: false },
    ],
  },
  {
    label: "Group I",
    teams: [
      { name: "Netherlands", code: "nl", group: "I", powerScore: 79, attack: 78, defense: 76, form: 80, fifaRank: 6,  advancedToKO: true },
      { name: "Turkiye",     code: "tr", group: "I", powerScore: 68, attack: 67, defense: 65, form: 69, fifaRank: 19, advancedToKO: true },
      { name: "Croatia",     code: "hr", group: "I", powerScore: 66, attack: 65, defense: 68, form: 65, fifaRank: 16, advancedToKO: false },
      { name: "Paraguay",    code: "py", group: "I", powerScore: 58, attack: 57, defense: 59, form: 58, fifaRank: 32, advancedToKO: false },
    ],
  },
  {
    label: "Group J",
    teams: [
      { name: "England",     code: "gb-eng", group: "J", powerScore: 80, attack: 81, defense: 78, form: 81, fifaRank: 4,  advancedToKO: true },
      { name: "Senegal",     code: "sn",      group: "J", powerScore: 67, attack: 65, defense: 66, form: 68, fifaRank: 20, advancedToKO: true },
      { name: "Egypt",       code: "eg",      group: "J", powerScore: 59, attack: 57, defense: 61, form: 57, fifaRank: 34, advancedToKO: false },
      { name: "Czechia",     code: "cz",      group: "J", powerScore: 62, attack: 61, defense: 63, form: 61, fifaRank: 27, advancedToKO: false },
    ],
  },
  {
    label: "Group K",
    teams: [
      { name: "USA",         code: "us", group: "K", powerScore: 73, attack: 70, defense: 72, form: 74, fifaRank: 11, advancedToKO: true },
      { name: "Argentina",   code: "ar", group: "K", powerScore: 90, attack: 92, defense: 84, form: 88, fifaRank: 2,  advancedToKO: true },
      { name: "Bosnia",      code: "ba", group: "K", powerScore: 55, attack: 54, defense: 56, form: 54, fifaRank: 48, advancedToKO: false },
      { name: "S. Africa",   code: "za", group: "K", powerScore: 52, attack: 51, defense: 53, form: 51, fifaRank: 45, advancedToKO: false },
    ],
  },
  {
    label: "Group L",
    teams: [
      { name: "Portugal",    code: "pt", group: "L", powerScore: 83, attack: 86, defense: 77, form: 82, fifaRank: 7,  advancedToKO: true },
      { name: "Canada",      code: "ca", group: "L", powerScore: 71, attack: 70, defense: 70, form: 72, fifaRank: 13, advancedToKO: true },
      { name: "Senegal",     code: "sn", group: "L", powerScore: 67, attack: 65, defense: 66, form: 68, fifaRank: 20, advancedToKO: false },
      { name: "S. Arabia",   code: "sa", group: "L", powerScore: 54, attack: 52, defense: 57, form: 53, fifaRank: 40, advancedToKO: false },
    ],
  },
];
